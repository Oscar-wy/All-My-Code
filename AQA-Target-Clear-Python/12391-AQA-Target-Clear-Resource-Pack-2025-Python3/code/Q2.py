        ...
        if CheckIfUserInputValid(UserInput):
            ...
            if CheckNumbersUsedAreAllInNumbersAllowed(NumbersAllowed, UserInputInRPN, MaxNumber):
                ...
                #CHANGE
                    ...
                    print("Your expression doesn't evaluate to one of the targets.")
            else:
                print("Your expression includes values which are not valid.")
        else:
            print("That is not a valid expression, please try again")
        print()
        #END CHANGE
        Score -= 1
        if Targets[0] != -1:
