...
def PlayGame(Targets, NumbersAllowed, TrainingGame, MaxTarget, MaxNumber):
    ...
    while not GameOver:
        ...
        #CHANGE
        UserInput = input("Enter an expression or enter MOVE to move the Targets list to the right one step (costs 2 points): ").upper()
        print()
        if UserInput == "MOVE":
            Score = MoveTargetsBack(Targets, Score)
        else:
