...
def PlayGame(Targets, NumbersAllowed, TrainingGame, MaxTarget, MaxNumber):
    ...
    while not GameOver:
        ...
        if (random.randint(0,3) == 1):
            print("Challenge Mode Activated. In this turn you must use all 5 numbers.")
            print("If you achieve this you will be awarded an extra 10 points.")
            print("If you do not achieve this, your score will be reduced by 5 points.")
            ChallengeMode = True
        ...
        if CheckIfUserInputValid(UserInput):
            ...
            if CheckNumbersUsedAreAllInNumbersAllowed(NumbersAllowed, UserInputInRPN, MaxNumber):
                IsTarget, Score = CheckIfUserInputEvaluationIsATarget(Targets, UserInputInRPN, Score, ChallengeMode)
                if IsTarget:
...
#CHANGE
def CheckIfUserInputEvaluationIsATarget(Targets, UserInputInRPN, Score, ChallengeMode):
    NumbersUsed = 0
    for s in UserInputInRPN:
        if s.isdigit(): #str.isdigit() doesn't pick up negative numbers, but works for this program
            NumbersUsed += 1    
    ...
    if UserInputEvaluation != -1:
        ...
        if UserInputEvaluationIsATarget and ChallengeMode and NumbersUsed == 5:
            print("Challenge Mode achieved. You are awarded an additional 10 points")   
            print()
            Score += 10
        elif UserInputEvaluationIsATarget and ChallengeMode and NumbersUsed < 5:
            print("Challenge Mode not achieved. 5 points are deducted from your score.")  
            print()
            Score -= 5
